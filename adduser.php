                                ...
                                <div class="card-box">
                                    ...
                                    <div class="col-xl-8">
                                            <div class="card-box">
                                                ...
                                                <form action="./get_user.php" method="post" class="form-horizontal" role="form" data-parsley-validate novalidate>

                                                    <div class="form-group row">
                                                        <label for="hori-pass1" class="col-sm-4 col-form-label">ชื่อ-นามสกุล</label>
                                                        <div class="col-sm-7">
                                                            <input id="hori-pass1" type="text" name="user_name" placeholder="ชื่อ-นามสกุล" required
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input data-parsley-equalto="#hori-pass1" type="text" name="user_username" required
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input data-parsley-equalto="#hori-pass1" type="password" name="user_password" required
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select id="ut_id" name="ut_id" class="form-control">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select id="ad_id" name="user_id" class="form-control">
