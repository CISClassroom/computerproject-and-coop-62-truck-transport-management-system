...
<body>
    ...
    $ad_id = $_GET['ad_id'];
    $qurey = mysqli_query($con, "SELECT * from admintype where ad_id = '$ad_id'") or die("Database selection failed: " . mysqli_error($con));
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="card-box">
                            ...
                            <form name="form" action="counter_addcar_save.php" method="post" class="form-horizontal"
                                onsubmit="" role="form" data-parsley-validate novalidate>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control " name="company_id">
                                            ...
                                            ?>
                                            <option value="<?php echo $re['user_id'] ?>">
                                                <?php echo $re['company_name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control " name="car_form">
                                            ...
                                            ?>
                                            <option value="<?php echo $re2['form_id'] ?>">
                                                <?php echo $re2['form_name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    <label for="inputPassword3"class="col-sm-2 col-form-label">ชื่อ-นามสกุลคนขับ</label>
                                        <div class="col-sm-10">
                                        <select class="form-control " name="car_name_cf">
                                            <option>--เลือกแบบฟอร์ม--</option>
                                            <?php
                                            $user_id= $_GET['user_id'];

                                            $qr_2 = mysqli_query($con, "SELECT * from car_driver  WHERE user_id = '$user_id' ") or die("Database selection failed: " . mysqli_error($con));
                                            while ($re2 = mysqli_fetch_array($qr_2, MYSQLI_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $re2['user_id'] ?>">
                                                <?php echo $re2['driver_name'] ?></option>
                                            <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="name" type="text" name="car_plate" placeholder="กรอกป้ายทะเบียนรถ"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control " name="car_province">
                                            ...
                                            while ($re = mysqli_fetch_array($qr_1, MYSQLI_ASSOC)) {
                                            ?>
                                            <option value="<?php echo $re['name_th'] ?>"><?php echo $re['name_th'] ?>
                                            </option>
                                            <?php
                                            }
                                            ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="name" type="text" name="car_licenseplatetail"
                                            placeholder="( ถ้ามี ) " required class="form-control">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" placeholder="วว/ดด/ปป.."
                                            data-date-format="yyyy-mm-dd" type="date" name="dateRegis" id="dateRegis"
                                            required value="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="name" type="text" name="car_insurance_company" placeholder=" "
                                            required class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" placeholder="วว/ดด/ปป.."
                                            data-date-format="yyyy-mm-dd" type="date" name="dateExIns" required
                                            class="form-control">
                                    </div>
                                    <label for="hori-pass1" class="col-sm-2 col-form-label">วันที่ภาษีหมดอายุ</label>
                                    <div class="col-sm-4">
                                        <input class="form-control" placeholder="วว/ดด/ปป.."
                                            data-date-format="yyyy-mm-dd" type="date" name="dateExTax" required
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group text-right mb-0">
                                    <button class="btn btn-success  waves-effect width-md waves-light" name="submit"
                                        type="submit">
                                        บันทึก
                                    </button>
                                </div>
