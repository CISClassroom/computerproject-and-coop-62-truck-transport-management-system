                            ...
                            <div class="card-box">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                                    ...
                                    <tbody>
                                       ...
                                       $query = mysqli_query($con, "SELECT * from car_form 
                                       where user_id = '$_SESSION[user_id]'") or die("Database selection failed: " . mysqli_error($con));
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group mb-1">
                                                        ...
                                                        <a class="btn btn-danger waves-effectr" data-animated href="JavaScript:if(confirm('ต้องการลบ ใช่หรือไม่?')==true){window.location='counter_form_del.php?fid=<?php echo $result['form_id'] ?>';}">
                                                            ลบ </a>
