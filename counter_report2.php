...
where 1 ORDER BY car_data.date_add DESC") or die("Database selection failed: " . mysqli_error($con));
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4>รายการตรวจที่ระบุเพิ่มเติม</h4>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $i = '1';
                                    $query5 = mysqli_query($con, " SELECT * from report
														WHERE report_id = '$chk' 
														ORDER BY report.report_id ASC") or die("Database selection failed 5: " . mysqli_error($con));
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo  $result1['report_detail'] ?></td>	
                                        </tr>
                                    <?php
                                       // }
                                    }
