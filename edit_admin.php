...
<body>
    ...
    <form action="update_admin.php" method="POST" enctype="multipart/form-data" id="form1" >
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">บริษัทที่สังกัด</label>
                <div class="col-sm-9">
                <input type="text" name="ad_id"  required class="form-control"value="<?php echo $row["ad_id"]?>">
            </div>
         </div>
