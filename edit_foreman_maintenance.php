...
<body class="authentication-bg">
    ...
    <div id="wrapper">
        ...
        ?>
         <?php
        $query = "SELECT user.user_name, user.user_username,user.user_password, user.ad_id,user.user_id, user.image, company.user_id,company.company_name,usertype.ut_id,usertype.ut_name FROM user 
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <body>
                                        ...
                                        <form action="update_foreman_maintenance.php" method="POST" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo $row["ut_name"] ?></label>
                                                    </div>
                                            </div>

                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">ชื่อผู้ใช้</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">รูปประจำตัว*</label>
                                                <div class="col-sm-9">
