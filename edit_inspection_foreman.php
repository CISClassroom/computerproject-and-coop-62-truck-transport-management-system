...
<?php
require("inspection_foreman_topbar.php");
...
<body class="authentication-bg">
    ...
    <div id="wrapper">
        <?php
        require("inspection_foreman_left_sidebar.php");
        ?>
        <?php
        $query = "SELECT user.user_name, user.user_username,user.user_password,user.ad_id, user.user_id, user.image, company.user_id,company.company_name FROM user 
            INNER JOIN company ON user.user_id=company.user_id  WHERE  ad_id = '" . $_SESSION['ad_id'] . "' ";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <body>
                                        ...
                                        <form action="update_foreman_inspection.php" method="POST" enctype="multipart/form-data" id="form1">
