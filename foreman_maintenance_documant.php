                    ...
                    <div class="row">
                        <div class="col-xl-12 col-md-12">
                            ...
                            <div class=" text-right">
                                    <a href="foreman_maintenance_status.php?id=<?php echo $row['id']; ?>" class="btn btn-success  width-md waves-effect waves-light" id="sa-warning">ผ่านการตรวจสอบ</a>
                                    <a href="foreman_maintenance_documant_adddata.php?id=<?php echo $row['id']; ?>&&car=<?php echo $row['car_plate']; ?>" class="btn btn-danger  width-md waves-effect waves-light">ไม่ผ่าน</a>
                            </div>
                            <div class="clearfix"></div>
                                ...
                                <h4 class="header-title mt-0">รายละเอียด</h4><br>
