                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        while ($result = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                                            ...
                                            $show_select = "SELECT * FROM car_choice_problem WHERE car_id='$id'";
                                            $not_pass = 0;
                                            $true = 0;
                                            $status3 = '';
                                            ...
                                            if ($num > 0) {
                                                while ($result1 = mysqli_fetch_array($query2)) {
                                                    ...
                                                    if ($status2  == 0) {
                                                        ...
                                                        $status3 = "<button type='button' class='btn btn-warning btn-rounded width-md waves-effect'>ผ่าน แต่มีข้อแก้ไข</button>";
                                                    }
                                                    ...
                                                    if ($not_pass > 0) {
                                                        ...
                                                        if ($true > 0) {
                                                            ...
                                                            //$status3 = "<button type='button' class='btn btn-secondary btn-rounded width-md waves-effect'>รอการตรวจสอบ</button>";
                                                        }
                                                    }
                                                }
                                            }// else {
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td><?php echo  $result['car_plate'] ?></a></td>
                                                <td><?php echo  $result['car_province'] ?></td>
                                                <td><?php echo  $result['company_name'] ?></td>
                                                <td><?php echo  $result['form_name'] ?></td>
                                                <td><a href="inspection_report.php?car_id=<?php echo  $result['car_id'] ?>"><?php echo $status3 ?></a></td>
                                            </tr>
                                        <?php
                                            }
                                        }
