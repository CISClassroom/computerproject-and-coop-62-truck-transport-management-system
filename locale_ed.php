...
if ($data =='province') {
    echo "<select name='company_province' class=\"form-control\" onChange=\"dochange('amphur', this.value)\">\n";
    ...
    echo "<select name='company_amphur' class=\"form-control\" onChange=\"dochange('district', this.value)\">\n";
    ...
    echo "<select name='company_tumbon' class=\"form-control\">\n";
