...
--
-- Host: localhost
-- Generation Time: Apr 02, 2020 at 04:53 PM
...
INSERT INTO `admin` (`admin_id`, `admin_name`, `admin_username`, `admin_password`, `user_id`, `image`) VALUES
(36, 'แอดมิน บริษัทไทยสยาม', 'thaiadmin', 'thai1234', '29', '193788406720200303_120412.jpg'),
(37, 'SCG Admin', 'scgadmin', 'scg1234', '30', '47532473920200311_052320.png'),
(38, 'ปูนนก Admin', 'adminb', 'adminb', '34', '184631454320200401_052121.png');
...
CREATE TABLE `admintype` (
  ...
  `admin_zone` varchar(100) NOT NULL,
  `ad_name` varchar(120) NOT NULL,
  `admin_tax` varchar(100) NOT NULL,
  `admin_tel` varchar(100) NOT NULL,
  `admin_address` varchar(255) NOT NULL,
  `admin_province` varchar(100) NOT NULL,
  `admin_amphur` varchar(100) NOT NULL,
  `admin_tumbon` varchar(100) NOT NULL,
  `admin_zip` varchar(100) NOT NULL,
  `admin_date_add` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `admintype` (`ad_id`, `admin_zone`, `ad_name`, `admin_tax`, `admin_tel`, `admin_address`, `admin_province`, `admin_amphur`, `admin_tumbon`, `admin_zip`, `admin_date_add`) VALUES
(30, '2', 'car', '11-22-333-444', '0961840128', '111 ถ.ราชสีมาโชคชัย', '1', '37', '103704', '11000', '2020-02-29 21:35:02');
...
INSERT INTO `amphur` (`id`, `code`, `name_th`, `name_en`, `province_id`) VALUES
...
--
-- Table structure for table `car_choice_problem`
--

CREATE TABLE `car_choice_problem` (
  `id` int(11) NOT NULL,
  `car_id` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `num_id` int(11) NOT NULL,
  `check_pass` int(11) NOT NULL,
  `detail_check` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img_check` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` int(11) NOT NULL,
  `date_insert` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `car_choice_problem`
--

INSERT INTO `car_choice_problem` (`id`, `car_id`, `num_id`, `check_pass`, `detail_check`, `img_check`, `status`, `date_insert`) VALUES
(2, '3Y25UOJ3M48UFM904D', 16, 2, 'เปลี่ยนผิด', 'evidence_problem/16/เอกสาร.jpg', 0, '2020-03-17 18:05:47'),
(10, 'Z3AHB461N8JBTYP7OF', 15, 2, 'ไม่ผ่าน', 'evidence_problem/15/mail.png', 0, '2020-03-24 15:27:19'),
(25, 'DW3LUMK8VOS99X00VI', 14, 2, 'rezy', 'evidence_problem/14/ภาพพื้นหลังเรียบๆ.jpg', 0, '2020-03-29 20:26:28'),
(26, 'DW3LUMK8VOS99X00VI', 15, 2, 'l,fcyu', 'evidence_problem/15/computer-2846202_960_720.jpg', 0, '2020-03-29 20:26:28'),
(29, 'WRXVNM06CEITYK3COV', 14, 2, 'jb/i', 'evidence_problem/14/หัวหน้าซ่อมบำรุง.png', 0, '2020-03-29 21:01:11'),
(30, 'WRXVNM06CEITYK3COV', 15, 2, 'WRFWEF', 'evidence_problem/15/Admin.png', 0, '2020-03-29 21:01:11'),
(37, '79VWO0E7K5PN5IABBN', 14, 0, '', '', 0, '2020-03-30 00:59:48'),
(38, '79VWO0E7K5PN5IABBN', 15, 0, '', '', 0, '2020-03-30 00:59:48'),
(47, 'LC8Z4AW1VM2MVRTC34', 14, 0, '', '', 0, '2020-03-30 13:39:51'),
(48, 'LC8Z4AW1VM2MVRTC34', 15, 0, '', '', 0, '2020-03-30 13:39:51'),
(49, '56P4CBNLZA29S61V5V', 14, 0, '', '', 0, '2020-03-31 14:33:17'),
(50, '56P4CBNLZA29S61V5V', 15, 0, '', '', 0, '2020-03-31 14:33:17'),
(62, 'V2303WYOIVI4IWCI39', 15, 0, '', '', 0, '2020-03-31 23:21:30'),
(63, 'C21RL76H2BFXIY4NK7', 14, 0, '', '', 0, '2020-03-31 23:23:55'),
(64, 'C21RL76H2BFXIY4NK7', 15, 0, '', '', 0, '2020-03-31 23:23:55'),
(65, 'JYCZCKLI227CJP0654', 14, 0, '', '', 0, '2020-03-31 23:25:04'),
(66, 'JYCZCKLI227CJP0654', 15, 0, '', '', 0, '2020-03-31 23:25:04'),
(71, 'K5XWB5DSPBV9K6QC5J', 22, 1, 'dnmfg', 'evidence_problem/22/images.jpg', 0, '2020-04-01 01:45:12'),
(72, 'K5XWB5DSPBV9K6QC5J', 23, 2, 'tszeth', 'evidence_problem/23/ภาพพื้นหลังเรียบๆ.jpg', 0, '2020-04-01 01:45:12'),
(73, 'K5XWB5DSPBV9K6QC5J', 24, 1, 'asdsad', 'evidence_problem/24/bsysl2.jpg', 0, '2020-04-01 01:45:12'),
(74, 'K5XWB5DSPBV9K6QC5J', 25, 1, 'asdqw', 'evidence_problem/25/28660371_420569618375233_4603290173407494144_o.jpg', 0, '2020-04-01 01:45:12'),
(79, 'NEN6FR5SHVT4W07CHY', 26, 0, '', '', 0, '2020-04-01 12:39:25'),
(80, 'NEN6FR5SHVT4W07CHY', 27, 0, '', '', 0, '2020-04-01 12:39:25'),
(81, 'NEN6FR5SHVT4W07CHY', 28, 0, '', '', 0, '2020-04-01 12:39:25'),
(82, 'NEN6FR5SHVT4W07CHY', 29, 0, '', '', 0, '2020-04-01 12:39:25'),
(95, 'BE2QJ78R813SG6UPY9', 26, 0, '', '', 0, '2020-04-01 12:56:54'),
(96, 'BE2QJ78R813SG6UPY9', 27, 0, '', '', 0, '2020-04-01 12:56:54'),
(97, 'BE2QJ78R813SG6UPY9', 28, 0, '', '', 0, '2020-04-01 12:56:54'),
(98, 'BE2QJ78R813SG6UPY9', 29, 0, '', '', 0, '2020-04-01 12:56:54'),
(99, 'Y7THNEACCMOTTXUPY9', 14, 0, '', '', 0, '2020-04-01 13:01:44'),
(100, 'Y7THNEACCMOTTXUPY9', 15, 0, '', '', 0, '2020-04-01 13:01:44'),
(101, 'N7G7EUQYIJ2AMAVKCY', 22, 0, '', '', 0, '2020-04-01 13:18:51'),
(102, 'N7G7EUQYIJ2AMAVKCY', 23, 0, '', '', 0, '2020-04-01 13:18:51'),
(103, 'N7G7EUQYIJ2AMAVKCY', 24, 0, '', '', 0, '2020-04-01 13:18:51'),
(104, 'N7G7EUQYIJ2AMAVKCY', 25, 0, '', '', 0, '2020-04-01 13:18:51');
...
CREATE TABLE `car_data` (
  `rec` int(11) NOT NULL,
  `car_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_name_cf` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_form` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_plate` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_province` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_licenseplatetail` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `car_insurance_company` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `dateRegis` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `dateExTax` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `dateExIns` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `user_update` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `car_data` (`rec`, `car_id`, `car_name_cf`, `car_form`, `car_plate`, `car_province`, `car_licenseplatetail`, `car_insurance_company`, `dateRegis`, `dateExTax`, `dateExIns`, `company_id`, `user_update`, `car_status`, `date_add`, `date_update`) VALUES
(39, '3Y25UOJ3M48UFM904D', 'นายสายฟ้า', '99774', 'กก1111', 'ชลบุรี', '-', 'ภาคิน ประกันภัย', '2020-03-17', '2020-03-17', '2020-03-17', '30', '', 0, '2020-03-17 18:05:47', '0000-00-00 00:00:00'),
(40, 'LNFJ2IY2O2GZ5JW6LS', 'ปวีณา ', '82036', 'ดด123', 'ระนอง', '-', 'สยามประกันภัย', '2020-03-17', '2020-03-17', '2020-03-17', '30', '', 0, '2020-03-17 20:27:12', '0000-00-00 00:00:00'),
(41, 'BB967DKJUPNPGYFIG6', '29', '82036', 'กก123', 'ชัยนาท', '--', 'ไทยสยาม', '2020-03-24', '2020-03-30', '2020-03-29', '30', '', 0, '2020-03-24 12:44:01', '0000-00-00 00:00:00'),
(42, 'HEVBKY8Q27PVW93VJ8', '30', '82036', 'ดด1111', 'ชลบุรี', '--', 'ไทยสยาม', '2020-03-24', '2020-03-29', '2020-03-27', '30', '', 0, '2020-03-24 12:49:03', '0000-00-00 00:00:00'),
(43, 'Z3AHB461N8JBTYP7OF', '30', '82036', '444', 'ชัยภูมิ', '--', 'ไทยสยาม', '2020-03-24', '2020-03-31', '2020-03-27', '30', '', 0, '2020-03-24 15:27:19', '0000-00-00 00:00:00'),
(44, '1TCIEYWPI13WUVGJH4', '29', '82036', 'r2233', 'กรุงเทพมหานคร', '-', 'dfd', '2020-03-18', '2020-03-31', '2020-03-23', '30', '', 0, '2020-03-24 17:26:06', '0000-00-00 00:00:00'),
(45, '14PX099WWBST2MK1H5', '29', '37349', 'o345', 'กรุงเทพมหานคร', '-', 'pp', '2020-03-04', '2020-03-27', '2020-03-28', '30', '', 0, '2020-03-24 17:36:35', '0000-00-00 00:00:00'),
(46, 'RFS6XIVYKFUIXTNF4Z', '29', '82036', 'gfd223', 'กรุงเทพมหานคร', '-', '-', '2020-03-25', '2020-04-01', '2020-03-25', '30', '', 0, '2020-03-24 17:38:06', '0000-00-00 00:00:00'),
(47, 'EC6U1RPK0TWWTDK3NV', '29', '82036', '1234', 'กรุงเทพมหานคร', '-', '-', '2020-03-16', '2020-03-31', '2020-03-24', '30', '', 0, '2020-03-24 17:56:05', '0000-00-00 00:00:00'),
(48, 'WH5B8T6AN7B11NU81S', '29', '82036', '4455', 'ขอนแก่น', '-', 'err', '2020-03-24', '2020-04-05', '2020-03-31', '30', '', 0, '2020-03-24 17:56:39', '0000-00-00 00:00:00'),
(49, 'WPEAHDYMGYKDPTZRT7', '29', '82036', '6543', 'ชลบุรี', '-', 'rt', '2020-03-24', '2020-03-31', '2020-03-24', '30', '', 0, '2020-03-24 17:57:15', '0000-00-00 00:00:00'),
(50, '3TWVGZ99H5BET8BWPM', '30', '82036', '125436', 'กรุงเทพมหานคร', '--', 'dd', '2020-03-27', '2020-03-18', '2020-03-27', '30', '', 0, '2020-03-25 17:50:58', '0000-00-00 00:00:00'),
(51, 'BL3576EZ5Y8ZPGXXHX', '29', '82036', '777', 'ตราด', '--', 'Driver Group', '2020-03-29', '2020-03-30', '2020-03-29', '30', '', 0, '2020-03-29 20:11:53', '0000-00-00 00:00:00'),
(52, 'DW3LUMK8VOS99X00VI', '30', '82036', '9999', 'กรุงเทพมหานคร', '--', 'Driver Group', '2020-03-29', '2020-03-30', '2020-03-30', '30', '', 0, '2020-03-29 20:26:28', '0000-00-00 00:00:00'),
(53, '41A5B4EJURUWH2D5GP', '30', '82036', '987', 'ชัยภูมิ', '--', 'Driver Group', '2020-03-29', '2020-03-31', '2020-03-30', '30', '', 0, '2020-03-29 21:00:40', '0000-00-00 00:00:00'),
(54, 'WRXVNM06CEITYK3COV', '30', '82036', '5555', 'ตรัง', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-29', '2020-03-31', '2020-03-30', '30', '', 0, '2020-03-29 21:01:11', '0000-00-00 00:00:00'),
(55, '33VHMI6IBXYP6LUG4T', '30', '82036', '1122', 'ขอนแก่น', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-30', '2020-03-31', '2020-03-31', '30', '', 0, '2020-03-30 00:31:44', '0000-00-00 00:00:00'),
(56, '9IUD5D761BY3LQWPP8', '30', '82036', '2222222', 'กำแพงเพชร', '--', 'Driver Group', '2020-03-30', '2020-04-14', '2020-03-31', '30', '', 0, '2020-03-30 00:32:25', '0000-00-00 00:00:00'),
(57, 'W8AF0OSHNDZFSBL02Z', '30', '82036', '8822', 'เพชรบูรณ์', '--', 'dd', '2020-03-30', '2020-04-25', '2020-04-09', '30', '', 0, '2020-03-30 00:40:30', '0000-00-00 00:00:00'),
(58, '79VWO0E7K5PN5IABBN', '30', '82036', '9666', 'กรุงเทพมหานคร', '--', 'Driver Group', '2020-03-30', '2020-04-05', '2020-03-03', '30', '', 0, '2020-03-30 00:59:48', '0000-00-00 00:00:00'),
(59, 'ZEYE4D6FVTTFBT717U', '30', '82036', '44444', 'นครสวรรค์', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-19', '2020-04-05', '2020-03-31', '30', '', 0, '2020-03-30 01:00:28', '0000-00-00 00:00:00'),
(60, '9AE8OJONPUZUPNFYYO', '30', '82036', '911111', 'ชัยภูมิ', '--', 'Driver Group', '2020-03-30', '2020-04-16', '2020-03-31', '30', '', 0, '2020-03-30 11:12:14', '0000-00-00 00:00:00'),
(61, 'SPA0BEBNHNCLPS8U6F', '30', '82036', '5656', 'นครสวรรค์', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-13', '2020-03-31', '2020-03-31', '30', '', 0, '2020-03-30 13:31:19', '0000-00-00 00:00:00'),
(62, 'FWSLPWYHTNHCERBYCV', '30', '82036', '5887412', 'นครศรีธรรมราช', '--', 'Driver Group', '2020-03-05', '2020-03-27', '2020-03-11', '30', '', 0, '2020-03-30 13:39:20', '0000-00-00 00:00:00'),
(63, 'LC8Z4AW1VM2MVRTC34', '30', '82036', '6666666', 'ขอนแก่น', '--', 'Driver Group', '2020-03-11', '2020-03-31', '2020-03-20', '30', '', 0, '2020-03-30 13:39:51', '0000-00-00 00:00:00'),
(64, '56P4CBNLZA29S61V5V', '30', '82036', '33333', 'นครนายก', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-31', '2020-04-24', '2020-04-10', '30', '', 0, '2020-03-31 14:33:17', '0000-00-00 00:00:00'),
(65, 'QRAHMIW7GXDA79JPXC', '30', '82036', '8181', 'ตาก', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-31', '2020-04-22', '2020-04-15', '30', '', 0, '2020-03-31 14:54:48', '0000-00-00 00:00:00'),
(66, '8N8V48HWJNLTPPVSDT', '30', '82036', '3232', 'ชุมพร', '--', 'dd', '2020-03-31', '2020-04-25', '2020-04-15', '30', '', 0, '2020-03-31 14:57:02', '0000-00-00 00:00:00'),
(67, '1FUJI2MCXKR2YED9MJ', '30', '82036', '9797', 'ขอนแก่น', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-31', '2020-04-29', '2020-04-24', '30', '', 0, '2020-03-31 14:58:56', '0000-00-00 00:00:00'),
(68, 'NBI7GV4ZYNT14BUKSM', '30', '82036', '3322', 'ฉะเชิงเทรา', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-31', '2020-05-01', '2020-04-08', '30', '', 0, '2020-03-31 22:18:01', '0000-00-00 00:00:00'),
(69, '7RYQYL15V37AA0W8GI', '30', '82036', '1111', 'นครศรีธรรมราช', '--', 'dd', '2020-03-31', '2020-04-18', '2020-04-09', '30', '', 0, '2020-03-31 23:01:22', '0000-00-00 00:00:00'),
(70, 'V2303WYOIVI4IWCI39', '30', '82036', '101010', 'ชัยภูมิ', '--', 'ไอดีไดฟว์ จำกัด', '2020-03-31', '2020-04-16', '2020-04-10', '30', '', 0, '2020-03-31 23:21:30', '0000-00-00 00:00:00'),
(71, 'C21RL76H2BFXIY4NK7', '30', '82036', '9090', 'นครปฐม', '--', 'Driver Group', '2020-03-31', '2020-04-11', '2020-04-10', '30', '', 0, '2020-03-31 23:23:55', '0000-00-00 00:00:00'),
(72, 'JYCZCKLI227CJP0654', '30', '82036', '8787', 'ตรัง', '--', 'Driver Group', '2020-03-31', '2020-04-18', '2020-04-08', '30', '', 0, '2020-03-31 23:25:04', '0000-00-00 00:00:00'),
(73, 'K8XJJUT5QKB9KYDT1Q', '30', '82036', '9393', 'ฉะเชิงเทรา', '--', 'Driver Group', '2020-03-06', '2020-03-19', '2020-03-28', '30', '', 0, '2020-03-31 23:26:46', '0000-00-00 00:00:00'),
(74, 'ZGZ5S47NYB6666HFPS', '30', '82036', '777777', 'นครพนม', '--', 'Driver Group', '2020-04-11', '2020-04-19', '2020-04-24', '30', '', 0, '2020-04-01 01:10:37', '0000-00-00 00:00:00'),
(75, '09FBZZ0PX3MKMDEUXV', '30', '37349', '373737', 'ตาก', '--', 'Driver Group', '2020-04-03', '2020-04-10', '2020-04-10', '30', '', 0, '2020-04-01 01:41:14', '0000-00-00 00:00:00'),
(76, 'K5XWB5DSPBV9K6QC5J', '30', '19770', '90000000', 'ชลบุรี', '--', 'Driver Group', '2020-04-03', '2020-04-16', '2020-04-18', '30', '', 0, '2020-04-01 01:45:12', '0000-00-00 00:00:00'),
(77, 'WOOEXO2TZ6AL9EP5IS', '30', '19770', '8888888', 'ตาก', '--', 'Driver Group', '2020-04-01', '2020-04-15', '2020-04-11', '30', '', 0, '2020-04-01 02:19:59', '0000-00-00 00:00:00'),
(78, 'NEN6FR5SHVT4W07CHY', '34', '78754', 'กก1111', 'กำแพงเพชร', '--', 'วิริยะ', '2020-04-01', '2020-04-18', '2020-04-10', '34', '', 0, '2020-04-01 12:39:25', '0000-00-00 00:00:00'),
(79, 'DVB6JAEN3YZ0Z18TFB', '34', '78754', '112233', 'ตรัง', '--', 'วิริยะ', '2020-04-01', '2020-04-16', '2020-04-11', '34', '', 0, '2020-04-01 12:41:03', '0000-00-00 00:00:00'),
(80, '0FQHI12JKG30Y0XV2H', '30', '19770', '3311', 'ชัยภูมิ', '--', 'dd', '2020-04-08', '2020-04-26', '2020-04-25', '30', '', 0, '2020-04-01 12:42:23', '0000-00-00 00:00:00'),
(81, 'JSDU0PZH62WGEDB3K6', '34', '78754', '112233333', 'ชัยภูมิ', '--', 'วิริยะ', '2020-04-08', '2020-04-19', '2020-04-19', '34', '', 0, '2020-04-01 12:43:53', '0000-00-00 00:00:00'),
(82, 'BE2QJ78R813SG6UPY9', '30', '78754', '9696969', 'ตาก', '--', 'วิริยะ', '2020-04-01', '2020-04-18', '2020-04-18', '30', '', 0, '2020-04-01 12:56:54', '0000-00-00 00:00:00'),
(83, 'Y7THNEACCMOTTXUPY9', '30', '82036', '87878787', 'ตราด', '--', 'Driver Group', '2020-04-02', '2020-04-18', '2020-04-11', '30', '', 0, '2020-04-01 13:01:44', '0000-00-00 00:00:00'),
(84, 'N7G7EUQYIJ2AMAVKCY', '30', '19770', '828282', 'ตาก', '--', 'Driver Group', '2020-04-16', '2020-04-04', '2020-04-03', '30', '', 0, '2020-04-01 13:18:51', '0000-00-00 00:00:00'),
(85, 'U6TT3YLG3F9JBQ25Q0', '30', '19770', 'kk11', 'ตาก', '--', 'วิริยะ', '2020-04-10', '2020-04-11', '2020-04-11', '30', '', 0, '2020-04-01 13:25:52', '0000-00-00 00:00:00'),
(86, 'NQC3307498ALDIGS48', '30', '19770', 'PP11', 'ชัยภูมิ', '--', 'Driver Group', '2020-04-11', '2020-04-18', '2020-04-09', '30', '', 0, '2020-04-01 13:28:51', '0000-00-00 00:00:00'),
(87, 'DUCE0YWI4VW1KQ207J', '30', '61463', 'จจ9999', 'กาฬสินธุ์', '--', 'วิริยะ', '2020-04-01', '2020-04-19', '2020-04-03', '30', '', 0, '2020-04-01 14:00:17', '0000-00-00 00:00:00'),
(88, '2O3WR1Q7A8YK3OKAEF', '30', '61463', 'ขข8888', 'ตราด', '--', 'ไอดีไดฟว์ จำกัด', '2020-04-04', '2020-04-10', '2020-04-11', '30', '', 0, '2020-04-01 14:12:41', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `car_dispatch`
--
...
CREATE TABLE `car_dispatch` (
  ...
  `car_province` varchar(200) NOT NULL,
  `car_address` varchar(200) NOT NULL,
  `work_type` varchar(100) NOT NULL,
  `price_oil` varchar(50) NOT NULL,
  `price_travel` varchar(50) NOT NULL,
  `car_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `car_dispatch`
--

INSERT INTO `car_dispatch` (`id`, `car_plate`, `car_company`, `car_province`, `car_address`, `work_type`, `price_oil`, `price_travel`, `car_date`) VALUES
(7, 'r2233', ' SGC', 'กรุงเทพมหานคร', 'ดเีอ', 'เิ่ เ', '11', '22', '2020-03-26 14:28:17'),
(9, '1234', ' SGC', 'กรุงเทพมหานคร', 'ะ่', '่ดเ', '200', '963', '2020-03-26 14:42:54'),
(10, '777', ' SGC', 'ตราด', 'ขอนแก่น', 'ขนส่ง', '200', '570', '2020-03-29 20:15:54'),
(11, '987', ' SGC', 'ชัยภูมิ', 'xjtet', 'rhfsr', '500', '800', '2020-03-29 21:03:47'),
(12, '6543', ' SGC', 'ชลบุรี', 'cggkx', 'fyk,g ', '100', '800', '2020-03-29 21:16:44'),
(13, '2222222', ' SGC', 'กำแพงเพชร', 'ขอนแก่น', 'ส่งปูน', '200', '300', '2020-03-30 00:35:51'),
(14, '911111', ' SGC', 'ชัยภูมิ', 'y4 5y', 'tse5rt', '200', '570', '2020-03-30 11:15:36'),
(15, '1122', ' SGC', 'ขอนแก่น', 'ขอนแก่น', 'ขนส่ง', '200', '300', '2020-03-30 14:34:41'),
(16, '3311', ' SGC', 'ชัยภูมิ', 'rttr', 'qf', '200', '300', '2020-04-01 13:23:56'),
(17, 'kk11', ' SGC', 'ตาก', '5H', 'ERAG', '200', '22', '2020-04-01 13:28:15'),
(18, 'PP11', ' SGC', 'ชัยภูมิ', '3FR', 'WEG', '200', '570', '2020-04-01 13:32:04'),
(19, 'ขข8888', ' SGC', 'ตราด', 'ขอนแก่น', 'ขนส่ง', '200', '300', '2020-04-01 14:14:45');
...
CREATE TABLE `car_driver` (
  ...
  `driver_department` varchar(100) NOT NULL,
  `user_id` int(3) NOT NULL,
  `driver_tel` varchar(11) NOT NULL,
...
INSERT INTO `car_driver` (`driver_id`, `driver_name`, `driver_department`, `user_id`, `driver_tel`, `driver_username`, `driver_password`, `lineid`) VALUES
(29, 'dddddddd', '6', 30, '11111111111', 'd111', 'd111', 'eee'),
(30, 'นายสะอาด ', '6', 29, '053-2311903', 'thaidriver', 'thaidriver', 'thaidriver'),
(31, 'นายดกทสิ', '1', 30, '02453', '25555', '11111', '11'),
(32, '', '1', 0, '', 'admin', '	 admin', ''),
(33, '', '', 0, '', '', '', 'ิดกอ'),
(34, '', '', 0, '', '', '', 'ิดกอ'),
(35, '', '', 0, '', '', '', 'ิดกอ'),
(36, 'ใบ', '3', 33, '02453', 'admin', '	 admin', '11111'),
(37, 'นายสมศรี ใจดี', '1', 30, '0875543378', 'driver', 'driver', 'somsri08'),
(38, 'นายสมศักดิ์ ยินดี', '3', 34, '0875543378', 'driver1', 'driver1', 'driver1'),
(39, 'นายสมศักดิ์ ยินดี', '3', 30, '0875543378', 'driver11', 'driver11', 'driver11');

-- --------------------------------------------------------

--
-- Table structure for table `car_form`
--

CREATE TABLE `car_form` (
  `number_rec` int(8) NOT NULL,
  `form_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Dumping data for table `car_form`
--

INSERT INTO `car_form` (`number_rec`, `form_id`, `form_name`, `user_id`, `date_insert`) VALUES
(16, '82036', 'ตรวจสภาพรถภายใน', 0, '2020-03-17 16:02:45'),
(17, '99774', 'ตรวจสภาพภายนอก', 30, '2020-03-17 16:33:42'),
(22, '19770', 'Baifern', 30, '2020-04-01 01:43:05'),
(23, '78754', 'ตรวจสภาพรถ', 34, '2020-04-01 12:36:18'),
(24, '61463', 'ตรวจสภาพรถ', 30, '2020-04-01 13:56:26');

-- --------------------------------------------------------

--
-- Table structure for table `car_form_choice`
--

CREATE TABLE `car_form_choice` (
  `num` int(11) NOT NULL,
  `form_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `form_sub_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `choice_detail` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `date_insert` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `car_form_choice`
--

INSERT INTO `car_form_choice` (`num`, `form_id`, `form_sub_id`, `choice_detail`, `date_insert`) VALUES
(14, '82036', 'E0OAMTXF', 'ความร้อน', '2020-03-17 16:17:44'),
(15, '82036', 'E0OAMTXF', 'หม้อน้ำ', '2020-03-17 16:17:53'),
(16, '99774', 'SQZABU7R', 'การเบรก', '2020-03-17 16:34:22'),
(22, '19770', '8DE3GIGS', 'เบรค', '2020-04-01 01:43:21'),
(23, '19770', '8DE3GIGS', 'ยางรถ', '2020-04-01 01:43:26'),
(26, '78754', 'GSLQBTAH', 'เปลี่ยนยางรถ', '2020-04-01 12:36:31'),
(27, '78754', 'GSLQBTAH', 'ล้อรถ', '2020-04-01 12:36:49'),
(28, '78754', 'KBF5VHCO', 'น้ำมันเครื่อง', '2020-04-01 12:37:01'),
(29, '78754', 'KBF5VHCO', 'น้ำมันเบรค', '2020-04-01 12:37:04'),
(30, '61463', '05WR3TTE', 'เปลี่ยนยางรถ', '2020-04-01 13:56:39'),
(31, '61463', '05WR3TTE', 'น้ำมันเครื่อง', '2020-04-01 13:56:46');

-- --------------------------------------------------------

--
-- Table structure for table `car_form_subject`
--

CREATE TABLE `car_form_subject` (
  `number_rec` int(8) NOT NULL,
  `form_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `form_sub_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `form_sub_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `date_insert` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `car_form_subject`
--

INSERT INTO `car_form_subject` (`number_rec`, `form_id`, `form_sub_id`, `form_sub_name`, `date_insert`) VALUES
(13, '82036', 'E0OAMTXF', 'เครื่องยนต์', '2020-03-17 16:02:55'),
(14, '99774', 'SQZABU7R', 'ล้อ', '2020-03-17 16:33:56'),
(18, '19770', '8DE3GIGS', 'รายการซ่อม', '2020-04-01 01:43:09'),
(20, '78754', 'GSLQBTAH', 'ตรวจสถาพรถภายนอก', '2020-04-01 12:36:27'),
(21, '78754', 'KBF5VHCO', 'ตรวจสถาพรถภายใน', '2020-04-01 12:36:58'),
(22, '61463', '05WR3TTE', 'ตรวจสถาพรถภายนอก', '2020-04-01 13:56:31');
...
CREATE TABLE `company` (
  ...
  `company_zone` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_name` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_tex` int(20) NOT NULL,
  `company_tel` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_address` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_province` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_amphur` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_tumbon` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `company_zip` int(5) NOT NULL,
...
INSERT INTO `company` (`user_id`, `company_zone`, `company_name`, `company_tex`, `company_tel`, `company_address`, `company_province`, `company_amphur`, `company_tumbon`, `company_zip`, `company_date_add`) VALUES
(30, '1', 'SGC', 0, '044-11111111', '200 ม.2 ถ.มะลิวัลย์', '28', '393', '400115', 0, '2020-03-11 02:28:48'),
(32, '', '', 0, '', '', '', '', '', 0, '2020-03-21 22:26:03'),
(34, '', 'ปูนนก', 0, '0981784474', '219/4', '29', '428', '410802', 0, '2020-04-01 12:19:33');
...
INSERT INTO `maintenance` (`id`, `detail`, `image`, `car_id`, `report_id`, `status`) VALUES
(1, 'saasdas', 'evidence_problem_update/8/รูปภาพ1.png', 42, 8, 'ผ่าน'),
(3, 'jjlk', 'evidence_problem_update/13/Thunyalak.jpg', 46, 13, 'ผ่าน'),
(4, '', 'evidence_problem_update/20/', 48, 20, 'ผ่าน'),
(5, 'เสร็จ', 'evidence_problem_update/13/computer-2846202_960_720.jpg', 46, 13, 'ผ่าน'),
(9, 'eeee', 'evidence_problem_update/9/ภาพพื้นหลังเรียบๆ.jpg', 43, 9, 'ผ่าน'),
(10, 'yyyy', 'evidence_problem_update/32/พนักงานซ่อมบำรุง.png', 61, 32, 'ผ่าน'),
(11, 'เสร็จ', 'evidence_problem_update/51/images.jpg', 73, 51, 'ผ่าน'),
(12, 'เสร็จแล้ว', 'evidence_problem_update/53/computer-2846202_960_720.jpg', 74, 53, 'ไม่ผ่าน'),
(13, 'gggg', 'evidence_problem_update/54/images.jpg', 74, 54, ''),
(14, 'xxxxx', 'evidence_problem_update/63/16076419320200219_174227.jpg', 81, 63, 'ผ่าน'),
(15, 'OOO', 'evidence_problem_update/73/9891020200329_085929.png', 86, 73, 'ผ่าน'),
(16, '4444', 'evidence_problem_update/48/9891020200329_085929.png', 69, 48, 'ไม่ผ่าน'),
(17, 'สำเร็จ', 'evidence_problem_update/75/1045925820200225_052037.jpg', 87, 75, 'ผ่าน');
...
INSERT INTO `province` (`id`, `code`, `name_th`, `name_en`, `geography_id`) VALUES
...
CREATE TABLE `report` (
  ...
  `license_car` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `report_topic` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `report_detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `image` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `report_status` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `report_date_add` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `report` (`report_id`, `license_car`, `report_topic`, `report_detail`, `image`, `report_status`, `report_date_add`) VALUES
(3, 'ดด123', 'ตรวจแล้ว', 'ปกติ', 'evidence_problem/14/ไทย.png', 'ผ่าน', '2020-03-24 12:41:16'),
(4, 'ดด123', 'ตรวจแล้ว', 'ปกติ', 'evidence_problem/15/เอกสาร.jpg', 'ผ่าน', '2020-03-24 12:41:28'),
(5, 'กก123', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/facebook.png', 'ไม่ผ่าน', '2020-03-24 12:46:03'),
(6, 'กก123', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/facebook.png', 'ผ่าน', '2020-03-24 12:46:37'),
(7, 'ดด1111', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/mail.png', 'ผ่าน', '2020-03-24 13:26:48'),
(8, 'ดด1111', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/facebook.png', 'ไม่ผ่าน', '2020-03-24 13:26:55'),
(9, '444', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/facebook.png', 'ผ่าน', '2020-03-24 15:30:53'),
(10, 'r2233', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/end.png', 'ผ่าน', '2020-03-24 17:28:19'),
(11, 'r2233', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/รูปภาพ2.jpg', 'ผ่าน', '2020-03-24 17:28:20'),
(12, 'gfd223', 'ตรวจแล้ว', 'ggg', 'evidence_problem/14/end.png', 'ไม่ผ่าน', '2020-03-24 17:40:13'),
(13, 'gfd223', 'ตรวจแล้ว', 'hh', 'evidence_problem/15/รูปภาพ2.jpg', 'ไม่ผ่าน', '2020-03-24 17:40:30'),
(14, '1234', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/S__4571138.jpg', 'ผ่าน', '2020-03-26 11:35:15'),
(15, '1234', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/S__4571141.jpg', 'ผ่าน', '2020-03-26 11:35:18'),
(16, '777', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/14/maxresdefault.jpg', 'ผ่าน', '2020-03-29 20:15:07'),
(17, '777', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ผ่าน', '2020-03-29 20:15:10'),
(18, '987', 'ตรวจแล้ว', 'ztehsr', 'evidence_problem/14/photographer-964023_960_720.webp', 'ผ่าน', '2020-03-29 21:03:05'),
(19, '987', 'ตรวจแล้ว', 'wseye', 'evidence_problem/15/maxresdefault.jpg', 'ผ่าน', '2020-03-29 21:03:07'),
(20, '4455', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/39403753_2221657764772744_3561771779632398336_o.jpg', 'ไม่ผ่าน', '2020-03-29 21:11:25'),
(21, '4455', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/44590854_2265776783694175_2853416829391470592_n.jpg', 'ไม่ผ่าน', '2020-03-29 21:11:27'),
(22, '6543', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/88965949_201208444437871_7216657264831102976_n.jpg', 'ผ่าน', '2020-03-29 21:15:19'),
(23, '6543', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/S__4571144.jpg', 'ผ่าน', '2020-03-29 21:15:22'),
(24, '2222222', 'ตรวจแล้ว', 'aaaa', 'evidence_problem/14/photographer-964023_960_720.webp', 'ผ่าน', '2020-03-30 00:35:08'),
(25, '2222222', 'ตรวจแล้ว', 'bbbb', 'evidence_problem/15/maxresdefault.jpg', 'ผ่าน', '2020-03-30 00:35:11'),
(26, '8822', 'ตรวจแล้ว', 'rrrrr', 'evidence_problem/14/computer-2846202_960_720.jpg', 'ไม่ผ่าน', '2020-03-30 00:44:15'),
(27, '8822', 'ตรวจแล้ว', 'iiiii', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ไม่ผ่าน', '2020-03-30 00:44:16'),
(28, '44444', 'ตรวจแล้ว', 'ดหแเ', 'evidence_problem/14/หัวหน้าซ่อมบำรุง.png', 'ผ่าน', '2020-03-30 01:03:26'),
(29, '44444', 'ตรวจแล้ว', 'เกดเ', 'evidence_problem/15/คนขับ.png', 'ไม่ผ่าน', '2020-03-30 01:03:28'),
(30, '911111', 'ตรวจแล้ว', 'afed', 'evidence_problem/14/ภาพพื้นหลังเรียบๆ.jpg', 'ผ่าน', '2020-03-30 11:14:20'),
(31, '911111', 'ตรวจแล้ว', 'aedgse', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ผ่าน', '2020-03-30 11:14:23'),
(32, '5656', 'ตรวจแล้ว', 'jgjtyu', 'evidence_problem/14/Thunyalak.jpg', 'ไม่ผ่าน', '2020-03-30 13:32:36'),
(33, '5656', 'ตรวจแล้ว', 'yutt', 'evidence_problem/15/poster_template.jpg', 'ไม่ผ่าน', '2020-03-30 13:32:40'),
(34, '5887412', 'ตรวจแล้ว', 'fffgggg', 'evidence_problem/14/โปรเตอร์งานนวัตกรรมล่าสุด1.png', 'ไม่ผ่าน', '2020-03-30 13:41:09'),
(35, '5887412', 'ตรวจแล้ว', 'vvvvvv', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ผ่าน', '2020-03-30 13:41:13'),
(36, '1122', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/ระบบจัดการการขนส่งทางรถบรรทุก.png', 'ผ่าน', '2020-03-30 14:33:54'),
(37, '1122', 'ตรวจแล้ว', 'tttt', 'evidence_problem/15/computer-2846202_960_720.jpg', 'ผ่าน', '2020-03-30 14:33:56'),
(38, '125436', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/images.jpg', 'ไม่ผ่าน', '2020-03-31 14:53:33'),
(39, '125436', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/15/maxresdefault.jpg', 'ไม่ผ่าน', '2020-03-31 14:53:34'),
(40, '8181', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/images.jpg', 'ไม่ผ่าน', '2020-03-31 14:56:13'),
(41, '3232', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/images.jpg', 'ผ่าน', '2020-03-31 14:58:07'),
(42, '3232', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/15/computer-2846202_960_720.jpg', 'ผ่าน', '2020-03-31 14:58:09'),
(43, '9797', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/images.jpg', 'ผ่าน', '2020-03-31 15:00:12'),
(44, '9797', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/15/maxresdefault.jpg', 'ไม่ผ่าน', '2020-03-31 15:00:13'),
(45, '8181', 'ตรวจแล้ว', 'rgar', 'evidence_problem/15/maxresdefault.jpg', 'ผ่าน', '2020-03-31 18:16:30'),
(46, '3322', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/14/images.jpg', 'ผ่าน', '2020-03-31 22:19:54'),
(47, '3322', 'ตรวจแล้ว', 'ไม่ผ่าน', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ไม่ผ่าน', '2020-03-31 22:19:56'),
(48, '1111', 'ตรวจแล้ว', '1111', 'evidence_problem/14/images.jpg', 'ไม่ผ่าน', '2020-03-31 23:03:19'),
(49, '1111', 'ตรวจแล้ว', 'ไม่ผ่าน', 'evidence_problem/15/maxresdefault.jpg', 'ไม่ผ่าน', '2020-03-31 23:03:21'),
(50, '101010', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/14/maxresdefault.jpg', 'ไม่ผ่าน', '2020-03-31 23:22:53'),
(51, '9393', 'ตรวจแล้ว', 'ผ่านแล้ว', 'evidence_problem/14/computer-2846202_960_720.jpg', 'ไม่ผ่าน', '2020-03-31 23:28:03'),
(52, '9393', 'ตรวจแล้ว', 'ไม่ผ่านการตรวจ', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ไม่ผ่าน', '2020-03-31 23:28:04'),
(53, '777777', 'ตรวจแล้ว', 'ffff', 'evidence_problem/14/images.jpg', 'ไม่ผ่าน', '2020-04-01 01:11:44'),
(54, '777777', 'ตรวจแล้ว', 'ไม่ผ่าน', 'evidence_problem/15/ภาพพื้นหลังเรียบๆ.jpg', 'ผ่าน', '2020-04-01 01:11:45'),
(55, '8888888', 'ตรวจแล้ว', 'ehyzr', 'evidence_problem/22/28660371_420569618375233_4603290173407494144_o.jpg', 'ผ่าน', '2020-04-01 02:21:26'),
(56, '8888888', 'ตรวจแล้ว', 'ersyree', 'evidence_problem/23/82863338_2640169712770009_3069937293402832896_o.jpg', 'ไม่ผ่าน', '2020-04-01 02:21:29'),
(57, '8888888', 'ตรวจแล้ว', 'rhzre', 'evidence_problem/24/40313190_1176496109155166_998945698684600320_o.jpg', 'ผ่าน', '2020-04-01 02:21:30'),
(58, '8888888', 'ตรวจแล้ว', 'ctjx', 'evidence_problem/25/ET4iAduUEAAi2eX.jpg', 'ไม่ผ่าน', '2020-04-01 02:21:32'),
(59, '112233', 'ตรวจแล้ว', 'wef', 'evidence_problem/26/18186.jpg', 'ผ่าน', '2020-04-01 13:06:19'),
(60, '112233', 'ตรวจแล้ว', 'efws', 'evidence_problem/27/9891020200329_085929.png', 'ไม่ผ่าน', '2020-04-01 13:06:22'),
(61, '112233', 'ตรวจแล้ว', 'wefw', 'evidence_problem/28/1045925820200225_052037.jpg', 'ผ่าน', '2020-04-01 13:06:23'),
(62, '112233', 'ตรวจแล้ว', 'wefw', 'evidence_problem/29/1984580220200225_053512.jpg', 'ไม่ผ่าน', '2020-04-01 13:06:24'),
(63, '112233333', 'ตรวจแล้ว', 'ewF', 'evidence_problem/26/18186.jpg', 'ผ่าน', '2020-04-01 13:10:59'),
(64, '112233333', 'ตรวจแล้ว', 'hfdxn', 'evidence_problem/28/1984580220200225_053512.jpg', 'ไม่ผ่าน', '2020-04-01 13:11:01'),
(65, '112233333', 'ตรวจแล้ว', 'WEF', 'evidence_problem/27/9891020200329_085929.png', 'ผ่าน', '2020-04-01 13:11:02'),
(66, '112233333', 'ตรวจแล้ว', 'dfv', 'evidence_problem/29/1045925820200225_052037.jpg', 'ไม่ผ่าน', '2020-04-01 13:11:03'),
(67, '3311', 'ตรวจแล้ว', 'sgvwsr', 'evidence_problem/22/18186.jpg', 'ผ่าน', '2020-04-01 13:22:33'),
(68, '3311', 'ตรวจแล้ว', 'egzr', 'evidence_problem/23/9891020200329_085929.png', 'ผ่าน', '2020-04-01 13:22:33'),
(69, '3311', 'ตรวจแล้ว', 'weg', 'evidence_problem/24/1045925820200225_052037.jpg', 'ผ่าน', '2020-04-01 13:22:34'),
(70, '3311', 'ตรวจแล้ว', 'mzt', 'evidence_problem/25/1984580220200225_053512.jpg', 'ผ่าน', '2020-04-01 13:22:36'),
(71, 'kk11', 'ตรวจแล้ว', '5y54', 'evidence_problem/22/18186.jpg', 'ผ่าน', '2020-04-01 13:27:18'),
(72, 'kk11', 'ตรวจแล้ว', 'we', 'evidence_problem/23/9891020200329_085929.png', 'ผ่าน', '2020-04-01 13:27:27'),
(73, 'PP11', 'ตรวจแล้ว', 'PPPP', 'evidence_problem/22/18186.jpg', 'ไม่ผ่าน', '2020-04-01 13:29:46'),
(74, 'PP11', 'ตรวจแล้ว', 'ewfE', 'evidence_problem/23/1045925820200225_052037.jpg', 'ไม่ผ่าน', '2020-04-01 13:29:47'),
(75, 'จจ9999', 'ตรวจแล้ว', 'ผ่าน', 'evidence_problem/30/18186.jpg', 'ผ่าน', '2020-04-01 14:01:57'),
(76, 'จจ9999', 'ตรวจแล้ว', 'ไม่ผ่าน', 'evidence_problem/31/9891020200329_085929.png', 'ไม่ผ่าน', '2020-04-01 14:01:59'),
(77, 'ขข8888', 'ตรวจแล้ว', 'ผ่านการตรวจ', 'evidence_problem/30/3332209620200318_070248.jpg', 'ผ่าน', '2020-04-01 14:13:59'),
(78, 'ขข8888', 'ตรวจแล้ว', 'ผ่านการตรวจ', 'evidence_problem/31/24094677820200329_125908.png', 'ผ่าน', '2020-04-01 14:14:02');
...
INSERT INTO `tumbon` (`id`, `zip_code`, `name_th`, `name_en`, `amphur_id`) VALUES
...
INSERT INTO `user` (`user_name`, `user_username`, `user_password`, `ad_id`, `user_id`, `ut_id`, `image`) VALUES
('แผนกจัดการ', 'counter', 'counter', 1, 29, 2, '118264107520200310_202029.jpg'),
('Thai foreman', 'thaiforeman', 'thaiforeman1', 2, 29, 3, '50001076920200308_175249.jpg'),
('admin', 'admin', 'admin', 3, 0, 99, '164867719520200331_222519.png'),
('แผนกจัดการเอกสาร', 'scgcounter', 'scgcounter', 6, 30, 2, '75067860420200331_222143.jpg'),
('พนักงานขับรถ', 'scgdriver', 'scgdriver', 7, 30, 3, '101430445820200331_214740.png'),
('แผนกจ่ายงาน ', 'scgdispatch', 'scgdispatch', 9, 30, 1, '174620187220200331_222031.jpg'),
('แผนกซ่อมบำรุง', 'scgmain', 'scgmain', 10, 30, 4, '11614614420200331_221554.png'),
('หัวหน้าแผนกซ่อมบำรุง ', 'scgfm', 'scgfm1', 11, 30, 5, '189034894320200331_221701.png'),
('หัวหน้าตรวจสภาพรถ ', 'scginspec', 'scginspec', 12, 30, 6, '113348877620200331_221339.png'),
('แผนกจัดการเอกสาร', 'counter1', 'counter1', 13, 34, 2, '91563006520200401_053730.jpg'),
('พนักงานขับรถ', 'driver', 'driver', 14, 34, 3, ''),
('พนักงานซ่อมบำรุง', 'maintenance', 'maintenance', 15, 34, 4, ''),
('หัวหน้าแผนกซ่อมบำรุง', 'foremanmantenance', 'foremanmantenance', 16, 34, 5, ''),
('หัวหน้างานตรวจสภาพรถ ', 'inspection', 'inspection', 17, 34, 6, ''),
('แผนกจ่ายงาน', 'dispatch', 'dispatch', 18, 34, 1, '');
...
(3, 'พนักงานขับรถ'),
(4, 'พนักงานซ่อมบำรุง'),
(5, 'หัวหน้าแผนกซ่อมบำรุง'),
(6, 'หัวหน้างานตรวจสภาพ');
...
--
-- Indexes for table `car_choice_problem`
--
ALTER TABLE `car_choice_problem`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `car_dispatch`
--
ALTER TABLE `car_dispatch`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `car_form`
--
ALTER TABLE `car_form`
  ADD PRIMARY KEY (`number_rec`);

--
-- Indexes for table `car_form_choice`
--
ALTER TABLE `car_form_choice`
  ADD PRIMARY KEY (`num`);

--
-- Indexes for table `car_form_subject`
--
ALTER TABLE `car_form_subject`
  ADD PRIMARY KEY (`number_rec`);
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `admintype`
--
ALTER TABLE `admintype`
  MODIFY `ad_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `car_choice_problem`
--
ALTER TABLE `car_choice_problem`
...
--
ALTER TABLE `car_data`
  MODIFY `rec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `car_dispatch`
--
ALTER TABLE `car_dispatch`
...
--
ALTER TABLE `car_driver`
  MODIFY `driver_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `car_form`
--
ALTER TABLE `car_form`
  MODIFY `number_rec` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `car_form_choice`
--
ALTER TABLE `car_form_choice`
  MODIFY `num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `car_form_subject`
--
ALTER TABLE `car_form_subject`
  MODIFY `number_rec` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `report`
  MODIFY `report_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `ad_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `usertype`
--
ALTER TABLE `usertype`
  MODIFY `ut_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
