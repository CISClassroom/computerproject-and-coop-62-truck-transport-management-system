<?php
    ...
    $query ="UPDATE user SET user_name='$user_name',user_username='$user_username',user_id='$user_id',user_password='$user_password',image='$newname' WHERE user_id='$user_id'";
    mysqli_query($con,$query);
    
     header("Location:setting_counter.php");
